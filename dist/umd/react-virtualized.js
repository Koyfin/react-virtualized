!(function(global, factory) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : factory((global.ReactVirtualized = {}), global.React, global.ReactDOM);
            ...
            },
            {
              ...
              value: function() {
                var _props = this.props,
                  ...
                  _getScrollState2 = this._getScrollState(),
  ...
  function createDetectElementResize(nonce) {
    ...
    var cancel,
      raf,
      attachEvent = 'undefined' != typeof document && document.attachEvent;
    if (!attachEvent) {
      var requestFrame = ((raf =
        ...
        (_this._onResize = function() {
          ...
          if (_this._parentNode) {
            var _height = _this._parentNode.offsetHeight || 0,
              ...
              newHeight = _height - paddingTop - paddingBottom,
              newWidth = _width - paddingLeft - paddingRight;
        ...
        },
        {
          ...
          value: function() {
            var _props = this.props,
              ...
              columnIndex =
                void 0 === _props$columnIndex ? 0 : _props$columnIndex,
              parent = _props.parent,
              _props$rowIndex = _props.rowIndex,
              rowIndex =
                void 0 === _props$rowIndex
                  ? this.props.index || 0
                  : _props$rowIndex;
  ...
  (CellMeasurer.__internalCellMeasurerFlag = !1),
  ...
  var DEFAULT_HEIGHT = 30,
    ...
    CellMeasurerCache = (function() {
      function CellMeasurerCache() {
        ...
        classCallCheck(this, CellMeasurerCache),
          ...
          (this.columnWidth = function(_ref) {
            ...
            return _this._columnWidthCache.hasOwnProperty(key)
          ...
          (this.rowHeight = function(_ref2) {
            ...
            return _this._rowHeightCache.hasOwnProperty(key)
        ...
        createClass(CellMeasurerCache, [
          ...
          },
          {
            ...
            value: function(rowIndex) {
              ...
              return this._cellHeightCache.hasOwnProperty(_key)
          ...
          },
          {
            ...
            value: function(rowIndex) {
              ...
              return this._cellWidthCache.hasOwnProperty(_key2)
  ...
  */
  ...
  unwrapExports(inDOM);
  var scrollbarSize$1 = unwrapExports(
    ...
    CollectionView = (function(_React$PureComponent) {
      function CollectionView() {
        ...
        return (
          ...
          (_this._calculateSizeAndPositionDataOnNextUpdate = !1),
          (_this._onSectionRenderedMemoizer = createCallbackMemoizer()),
          (_this._onScrollMemoizer = createCallbackMemoizer(!1)),
          ...
          (_this._onScroll = function(event) {
            if (event.target === _this._scrollingContainer) {
              ...
              var _this$props3 = _this.props,
                ...
                scrollbarSize$$1 = _this._scrollbarSize,
                ...
                scrollLeft = Math.max(
                  0,
                  Math.min(
                    totalWidth - width + scrollbarSize$$1,
                ...
                scrollTop = Math.max(
                  0,
                  Math.min(
                    totalHeight - height + scrollbarSize$$1,
          ...
          (_this._scrollbarSize = scrollbarSize$1()),
          ...
          [
              ...
              value: function(prevProps, prevState) {
                var _props2 = this.props,
                  ...
                  scrollPositionChangeReason =
                    _state.scrollPositionChangeReason,
            ...
            },
            {
              ...
              value: function(_ref4) {
                ...
                scrollLeft >= 0 && (newState.scrollLeft = scrollLeft),
                  scrollTop >= 0 && (newState.scrollTop = scrollTop),
            ...
            value: function(high, low, offset) {
              for (; low <= high; ) {
                var middle = low + Math.floor((high - low) / 2),
                  _currentOffset = this.getSizeAndPositionOfCell(middle).offset;
                if (_currentOffset === offset) return middle;
                _currentOffset < offset
                  ? (low = middle + 1)
                  : _currentOffset > offset && (high = middle - 1);
              }
        ...
        var _ref$maxScrollSize = _ref.maxScrollSize,
          maxScrollSize =
            void 0 === _ref$maxScrollSize
              ? getMaxElementSize()
              : _ref$maxScrollSize,
          params = objectWithoutProperties(_ref, ['maxScrollSize']);
  ...
  function updateScrollIndexHelper(_ref) {
    var cellSize = _ref.cellSize,
      ...
      hasScrollToIndex = scrollToIndex >= 0 && scrollToIndex < cellCount;
    hasScrollToIndex &&
    (size !== previousSize ||
  ...
  var win = void 0,
    ...
    SCROLL_POSITION_CHANGE_REASONS$__OBSERVED = 'observed',
    SCROLL_POSITION_CHANGE_REASONS$__REQUESTED = 'requested',
    Grid = (function(_React$PureComponent) {
      function Grid(props) {
        ...
        (_this._onGridRenderedMemoizer = createCallbackMemoizer()),
          ...
          (_this._recomputeScrollLeftFlag = !1),
          (_this._recomputeScrollTopFlag = !1),
          (_this._horizontalScrollBarSize = 0),
          (_this._verticalScrollBarSize = 0),
          (_this._scrollbarPresenceChanged = !1),
                ...
                var _ref =
                  ...
                  rowIndex =
                    void 0 === _ref$rowIndex
                      ...
                      : _ref$rowIndex,
                  offsetProps = _extends({}, this.props, {
              ...
              value: function(_ref2) {
                ...
                if (!(scrollTopParam < 0)) {
                  ...
                  var _props = this.props,
                    ...
                    scrollbarSize$$1 = instanceProps.scrollbarSize,
                    totalRowsHeight = instanceProps.rowSizeAndPositionManager.getTotalSize(),
                    totalColumnsWidth = instanceProps.columnSizeAndPositionManager.getTotalSize(),
                    scrollLeft = Math.min(
                      Math.max(0, totalColumnsWidth - width + scrollbarSize$$1),
                      scrollLeftParam,
                    ),
                    scrollTop = Math.min(
                      Math.max(0, totalRowsHeight - height + scrollbarSize$$1),
                      scrollTopParam,
                    );
                  if (
            ...
            },
            {
              ...
              value: function() {
                ...
                if (
                  ...
                  ('number' == typeof scrollLeft && scrollLeft >= 0) ||
                    ('number' == typeof scrollTop && scrollTop >= 0))
                ) {
            ...
            },
            {
              ...
              value: function(prevProps, prevState) {
                ...
                var columnOrRowCountJustIncreasedFromZero =
                  (columnCount > 0 && 0 === prevProps.columnCount) ||
                  (rowCount > 0 && 0 === prevProps.rowCount);
                scrollPositionChangeReason ===
                  SCROLL_POSITION_CHANGE_REASONS$__REQUESTED &&
                  (!autoWidth &&
                    scrollLeft >= 0 &&
                    (scrollLeft !== this._scrollingContainer.scrollLeft ||
              ...
              value: function() {
                ...
                var childrenToDisplay = this._childrenToDisplay,
                  showNoContentRenderer =
                    0 === childrenToDisplay.length && height > 0 && width > 0;
                return React.createElement(
                  'div',
                  _extends(
                    {
  ...
  function defaultOverscanIndicesGetter$1(_ref) {
    ...
    return (
      ...
      scrollDirection === SCROLL_DIRECTION_FORWARD$1
        ? {
  ...
  var InfiniteLoader = (function(_React$PureComponent) {
    function InfiniteLoader(props, context) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (
          InfiniteLoader.__proto__ || Object.getPrototypeOf(InfiniteLoader)
              ...
              promise &&
                promise.then(function() {
                  ...
                  (_ref2 = {
                    ...
                    (lastRenderedStartIndex = _ref2.lastRenderedStartIndex),
                    (lastRenderedStopIndex = _ref2.lastRenderedStopIndex),
                    (startIndex = _ref2.startIndex),
                    (stopIndex = _ref2.stopIndex),
                    startIndex > lastRenderedStopIndex ||
        ...
        },
        {
          ...
          value: function(startIndex, stopIndex) {
            var _this3 = this,
                ...
                if (unloadedRanges.length)
                  for (
                    ...
                    firstUnloadedRange.stopIndex -
                      ...
                      1 <
                      minimumBatchSize && firstUnloadedRange.startIndex > 0;
              ...
              squashedUnloadedRanges = unloadedRanges.reduce(function(
                reduced,
                unloadedRange,
              ) {
    ...
    function List() {
      ...
      return (
        ...
        (_this._cellRenderer = function(_ref2) {
          ...
          return (
            Object.getOwnPropertyDescriptor(style, 'width').writable &&
              (style.width = '100%'),
            rowRenderer({
              index: rowIndex,
              style: style,
        ...
        },
        {
          ...
          value: function() {
            var _props = this.props,
              ...
              width = _props.width,
              classNames = classnames('ReactVirtualized__List', className);
            return React.createElement(
              Grid,
              _extends({}, this.props, {
  ...
  function rebuildWithoutInterval(node, interval) {
    ...
    return idx < 0
      ? NOT_FOUND
      : (intervals.splice(idx, 1), rebuild(node, intervals), SUCCESS);
  }
  ...
  (proto.intervals = function(result) {
    ...
    (proto.insert = function(interval) {
      ...
      if (((this.count += 1), interval[1] < this.mid))
        this.left
          ? 4 * (this.left.count + 1) > 3 * (weight + 1)
            ? rebuildWithInterval(this, interval)
            : this.left.insert(interval)
          : (this.left = createIntervalTree([interval]));
      else if (interval[0] > this.mid)
        this.right
          ? 4 * (this.right.count + 1) > 3 * (weight + 1)
            ? rebuildWithInterval(this, interval)
    ...
    (proto.remove = function(interval) {
      ...
      if (interval[1] < this.mid) {
        return this.left
          ? 4 * (this.right ? this.right.count : 0) > 3 * (weight - 1)
            ? rebuildWithoutInterval(this, interval)
            : 2 === (r = this.left.remove(interval))
              ? ((this.left = null), (this.count -= 1), SUCCESS)
              : (r === SUCCESS && (this.count -= 1), r)
          : NOT_FOUND;
      } else {
        if (!(interval[0] > this.mid)) {
          if (1 === this.count)
            return this.leftPoints[0] === interval ? 2 : NOT_FOUND;
          if (1 === this.leftPoints.length && this.leftPoints[0] === interval) {
            if (this.left && this.right) {
              for (var p = this, n = this.left; n.right; )
                (p = n), (n = n.right);
            ...
            if (this.leftPoints[l] === interval) {
              ...
              for (
                ...
                if (this.rightPoints[r] === interval)
                  return this.rightPoints.splice(r, 1), SUCCESS;
            }
          return NOT_FOUND;
        }
        return this.right
          ? 4 * (this.left ? this.left.count : 0) > 3 * (weight - 1)
            ? rebuildWithoutInterval(this, interval)
            : 2 === (r = this.right.remove(interval))
              ? ((this.right = null), (this.count -= 1), SUCCESS)
              : (r === SUCCESS && (this.count -= 1), r)
          : NOT_FOUND;
        var r;
      }
      ...
      function Masonry() {
        ...
        return (
          (_temp = _this = possibleConstructorReturn(
            this,
            (_ref =
              Masonry.__proto__ || Object.getPrototypeOf(Masonry)).call.apply(
              _ref,
              [this].concat(args),
            ),
          )),
          ...
          (_this._onScroll = function(event) {
            var height = _this.props.height,
              eventScrollTop = event.target.scrollTop,
              scrollTop = Math.min(
                ...
                if (
                  (this._positionCache.range(
                    ...
                    function(index, left, top) {
                      var _style;
                      void 0 === stopIndex
                        ? ((startIndex = index), (stopIndex = index))
                        ...
                        children.push(
                          cellRenderer({
                            ...
                            defineProperty(_style, 'position', 'absolute'),
                            defineProperty(_style, 'top', top),
                            defineProperty(
                              _style,
                              'width',
              ...
              value: function() {
                if ('number' == typeof this._invalidateOnUpdateStartIndex) {
                  var _startIndex = this._invalidateOnUpdateStartIndex,
                    _stopIndex = this._invalidateOnUpdateStopIndex;
            ...
            },
            {
              ...
              value: function() {
                var _ref =
                  ...
                  _ref$columnIndex = _ref.columnIndex,
                  columnIndex =
                    void 0 === _ref$columnIndex ? 0 : _ref$columnIndex,
                  _ref$rowIndex = _ref.rowIndex,
                  rowIndex = void 0 === _ref$rowIndex ? 0 : _ref$rowIndex;
                (this._deferredInvalidateColumnIndex =
                  'number' == typeof this._deferredInvalidateColumnIndex
                    ? Math.min(this._deferredInvalidateColumnIndex, columnIndex)
                    : columnIndex),
            ...
            },
            {
              ...
              value: function() {
                var _ref2 =
                  ...
                  columnIndex =
                    void 0 === _ref2$columnIndex ? 0 : _ref2$columnIndex,
                  _ref2$rowIndex = _ref2.rowIndex,
                  rowIndex = void 0 === _ref2$rowIndex ? 0 : _ref2$rowIndex,
                  _props = this.props,
            ...
            },
            {
              ...
              value: function() {
                var _props3 = this.props,
                  ...
                  scrollToColumn = (_props3.onScrollbarPresenceChange,
                  _props3.scrollLeft,
                  _props3.scrollToColumn),
                  scrollToRow = (_props3.scrollTop, _props3.scrollToRow),
                  rest = objectWithoutProperties(_props3, [
                    'onScroll',
                    'onSectionRendered',
                    'onScrollbarPresenceChange',
                    'scrollLeft',
                  ...
                  ? {
                      scrollLeft:
                        ...
                        nextProps.scrollLeft >= 0
                          ...
                          : prevState.scrollLeft,
                      scrollTop:
                        null != nextProps.scrollTop && nextProps.scrollTop >= 0
                          ? nextProps.scrollTop
                          : prevState.scrollTop,
                    }
                  : null;
    ...
    (this.state = {
      ...
      (this._cellRendererBottomLeftGrid = function(_ref3) {
        var rowIndex = _ref3.rowIndex,
          rest = objectWithoutProperties(_ref3, ['rowIndex']),
          _props5 = _this2.props,
          cellRenderer = _props5.cellRenderer,
          fixedRowCount = _props5.fixedRowCount;
        return rowIndex === _props5.rowCount - fixedRowCount
      ...
      (this._cellRendererBottomRightGrid = function(_ref4) {
        var columnIndex = _ref4.columnIndex,
          ...
          rest = objectWithoutProperties(_ref4, ['columnIndex', 'rowIndex']),
          _props6 = _this2.props,
      ...
      (this._cellRendererTopRightGrid = function(_ref5) {
        var columnIndex = _ref5.columnIndex,
          rest = objectWithoutProperties(_ref5, ['columnIndex']),
          _props7 = _this2.props,
      ...
      (this._columnWidthRightGrid = function(_ref6) {
        ...
        return _state3.showHorizontalScrollbar &&
      ...
      (this._onScrollbarPresenceChange = function(_ref7) {
        ...
        if (
          ...
          var onScrollbarPresenceChange =
            _this2.props.onScrollbarPresenceChange;
      ...
      (this._rowHeightBottomGrid = function(_ref8) {
        var index = _ref8.index,
          _props9 = _this2.props,
          fixedRowCount = _props9.fixedRowCount,
          rowCount = _props9.rowCount,
          rowHeight = _props9.rowHeight,
          _state5 = _this2.state,
          scrollbarSize = _state5.scrollbarSize,
          showHorizontalScrollbar = _state5.showHorizontalScrollbar;
        return index === rowCount - fixedRowCount
  ...
  var ScrollSync = (function(_React$PureComponent) {
    function ScrollSync(props, context) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (ScrollSync.__proto__ || Object.getPrototypeOf(ScrollSync)).call(
          this,
          props,
          context,
        ),
  ...
  function SortIndicator(_ref) {
    var sortDirection = _ref.sortDirection,
      classNames = classnames('ReactVirtualized__Table__sortableHeaderIcon', {
        ...
        },
        {
          ...
          value: function(_ref6) {
            var _this3 = this,
              ...
              className = classnames('ReactVirtualized__Table__row', rowClass),
              flattenedStyle = _extends(
                {},
                style,
                {
          ...
          value: function() {
            if (this.Grid) {
              var _Grid = ReactDOM.findDOMNode(this.Grid),
                ...
                scrollbarWidth = (_Grid.offsetWidth || 0) - clientWidth;
              this.setState({
                scrollbarWidth: scrollbarWidth,
              });
            }
      ...
      return (
        ...
        }),
        {
          sort: function(_ref2) {
            ...
            if (event.shiftKey)
              sortDirection.hasOwnProperty(dataKey)
